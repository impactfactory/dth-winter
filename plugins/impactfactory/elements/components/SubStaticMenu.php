...
use Ffte\Elements\Classes\SubMenu;
use Request;
 ...
 */
class SubStaticMenu extends ComponentBase
{
    /**
    ...
    public function getCodeOptions()
    {
        ...
        $menus = SubMenu::listInTheme($theme, true);
    ...
    public function menuItems()
    {
        ...
        $menu = SubMenu::loadCached($theme, $this->property('code'));
